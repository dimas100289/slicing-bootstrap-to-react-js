...
class App extends React.Component{
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6">
            <div class="icon-box">
              ...
              <h4 class="title"><a href="Lorem">Lorem Ipsum</a></h4>
          ...
          <div class="col-lg-4 col-md-6 mt-4 mt-md-0">
            <div class="icon-box">
              ...
              <h4 class="title"><a href="Dolor">Dolor Sitema</a></h4>
          ...
          <div class="col-lg-4 col-md-6 mt-4 mt-lg-0">
            <div class="icon-box">
              ...
              <h4 class="title"><a href="sed">Sed ut perspiciatis</a></h4>
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
            <div class="icon-box">
              ...
              <h4><a href="lorem">Lorem Ipsum</a></h4>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0">
            <div class="icon-box">
              ...
              <h4><a href="sed">Sed ut perspiciatis</a></h4>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-lg-0">
            <div class="icon-box">
              ...
              <h4><a href="magni">Magni Dolores</a></h4>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4">
            <div class="icon-box">
              ...
              <h4><a href="dele">Dele cardo</a></h4>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4">
            <div class="icon-box">
              ...
              <h4><a href="divera">Divera don</a></h4>
    ...
    <section id="cta" class="cta">
      <div class="container">
        ...
        <div class="text-center">
          ...
          <a class="cta-btn" href="#call">Call To Action</a>
        </div>
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
            <div class="member">
              ...
              <div class="social">
                <a href="socia"><i class="icofont-twitter"></i></a>
                <a href="social"><i class="icofont-facebook"></i></a>
                <a href="social"><i class="icofont-instagram"></i></a>
                <a href="social"><i class="icofont-linkedin"></i></a>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
            <div class="member">
              ...
              <div class="social">
                <a href="social"><i class="icofont-twitter"></i></a>
                <a href="social"><i class="icofont-facebook"></i></a>
                <a href="social"><i class="icofont-instagram"></i></a>
                <a href="social"><i class="icofont-linkedin"></i></a>
              </div>
  ...
  <a href="#back" class="back-to-top"><i class="icofont-simple-up"></i></a>
      </>
    )
  }
}
